...
def calculate_odds(user_responses, is_section_8_skipped):
    ...
    for i, response_value in enumerate(user_responses):
        ...
        if response_value is None:
            st.warning(f"請回答第 {i + 1} 項 (Please answer Section {i + 1}).")
            return None, None 
...
sections_data = [
    ...
    ("第二項：個人起居（梳洗、穿衣等）", ["我可以如常的照顧自己，不會感到任何額外的痛楚。", "我可以如常的照顧自己，但感到非常痛楚。", "照顧自己時感到痛楚，我需小心及緩慢行動。", "我能應付大部分的起居生活，但需要其他人的一些幫助。", "我每天都需要別人幫助照顧大部份的起居生活。", "我不能夠自己穿衣，梳洗也有困難，只可以臥床休息。"]),
    ("第三項：提起物件", ["我可以提起很重的物件，而不會造成額外的痛楚。", "我可以提起很重的物件，但會造成額外的痛楚。", "疼痛使我不能從地上提起很重的物件，但假如物件放在一個適當的位置，我仍可以拿起。", "疼痛使我不能提起很重的物件，但假如物件放在一個適當的位置，我可以拿起一些輕便或不太重的物件。", "我只可以提起一些非常輕的物件。", "我根本不能提起任何物件。"]),
    ("第四項：步行", ["疼痛不會影響我步行多少路程。", "疼痛使我不能步行多過一小時。", "疼痛使我不能步行多過半小時。", "疼痛使我不能步行多過十五分鐘。", "我需要用拐杖行路。", "我大部份時間臥床，只能爬去洗手間。"]),
    ("第五項：坐下", ["我可以坐在任何座椅上多久也沒有問題。", "我可以坐在慣常的座椅上多久也沒有問題。", "疼痛使我不能坐超過一小時。", "疼痛使我不能坐超過半小時。", "疼痛使我不能坐超過十五分鐘。", "疼痛使我根本不能坐下。"]),
    ("第六項：站立", ["我可以站久也不會造成任何額外的痛楚。", "我可以站很久，但會有額外的痛楚。", "疼痛使我不能站立超過一小時。", "疼痛使我不能站立超過半小時。", "疼痛使我不能站立超過十分鐘。", "疼痛使我完全不能站立。"]),
    ("第七項：睡眠", ["疼痛從不影響我的睡眠。", "有時候疼痛影響我的睡眠。", "疼痛使我不能睡眠超過六小時。", "疼痛使我不能睡眠超過四小時。", "疼痛使我不能睡眠超過兩小時。", "疼痛使我根本不能入睡。"]),
    ("第八項：性生活（註：如沒有性生活，毋須填寫此欄）", ["我的性生活正常，沒有任何額外的痛楚。", "我的性生活正常，但有點額外的痛楚。", "我的性生活正常，但非常疼痛。", "痛楚嚴重限制了我的性生活。", "由於痛楚關係，我差不多沒有性生活。", "痛楚使我完全不能有性生活。"]),
    ("第九項：社交生活", ["我的社交生活正常，沒有引起任何額外的痛楚。", "我的社交生活正常，但會增加痛楚的程度。", "疼痛不太影響我的社交生活，但使我不能作一些較劇烈的活動，例如運動等。", "疼痛限制了我的社交生活，使我不能經常外出活動。", "疼痛限制了我的社交生活，我只能留在家裡活動。", "由於痛楚的關係，我根本沒有任何社交生活。"]),
    ("第十項：舟車勞頓", ["我可以去任何地方，而旅途上的勞頓不會引起任何痛楚。", "我可以去任何地方，但旅途上的勞頓造成額外的痛楚。", "雖然很痛，但我仍可作多於兩小時的旅程。", "痛楚使我只可以作不超過一小時的旅程。", "痛楚使我只可以作少於三十分鐘的短途旅程。", "除了外出接受治療，疼痛使我不能有任何的舟車勞頓。"])
]
