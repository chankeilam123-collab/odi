...
sections_data = [
    ("第一部份：痛楚程度", ["現在沒有任何痛楚。", "現在只感到輕微的痛楚。", "現在感到中等程度的痛楚。", "現在感到非常痛楚。", "現在的痛楚程度非常嚴重。", "現在感到極度痛楚，痛楚的程度非莓其他人能夠想像。"]),
    ("第二部份：自我照顧（例如洗澡、穿衣服等）", ["我可以自我照顧，不會更痛。", "我可以自我照顧，但覺得很痛。", "自我照顧時很痛，我的動作需小心緩慢進行。", "大部分自我照顧都可以自己來，但需要一些協助。", "每天的自我照顧大部分都需要協助。", "我無法自己穿衣服，洗澡有困難，我都躺在床上。"]),
    ("第三部份：抬舉物品", ["我可以舉起重物，不會更痛。", "我可以舉起重物，但會更痛。", "疼痛讓我無法從地面舉起重物，但如果放在方聾的位置，我就可以。（例如：放在桌上）", "疼痛讓我無法舉起重物，但如果放在方聾的位置，我就可以舉起輕到中等重的東西。", "我只能舉起很輕的東西。", "我完全無法舉起或攜提任何東西。"]),
